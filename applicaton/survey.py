...
def thankyou():
    ...
    with connection:
        with connection.cursor() as cursor:
            ...
            # create a new user
            # create table `deer` (`id_user` INT UNSIGNED NOT NULL, `foundtick` VARCHAR(64) NOT NULL, `dogtick` VARCHAR(64) NOT NULL, `tickareas` VARCHAR(64) NOT NULL, `nattempts` INT NOT NULL, `timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (`id_user`));
